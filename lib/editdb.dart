...
class Editdb extends StatelessWidget {
   Editdb({super.key,required this.type});
    String type ;
...
final _lists = [
 ...
 //if(_name != null && _price != null && _count != null && _duration != null && _type != null)
  //  {
      final  _objects = StudentModel(name: _name, price: int.parse(_price) ,type: _type, count: _count , duration: _duration ,image: _image);
      addStudent(_objects);
      print(today);
