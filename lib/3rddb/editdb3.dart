...
class Editdb3 extends StatelessWidget {
   Editdb3({super.key});
    String type ='Fruits';
...
final _lists = [
 ...
 //if(_name != null && _price != null && _count != null && _duration != null && _type != null)
  //  {
      final  _objects = StudentModel3(name: _name, price: _price ,type: _type, count: _count , duration: _duration,image: _image );
      addStudent3(_objects);
      print(today);
